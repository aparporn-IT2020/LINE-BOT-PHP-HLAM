...
$httpClient = new \src\LINEBot\HTTPClient\CurlHTTPClient('6zDMyMWoEbyMb0inVnCxNeglFVxuDjbX7S3V1fq0cvnGwHHHliSwJ3a/bSIERUAdc+lWr4chqBXbwGJT9HnZGTDAUQUGAg0O58NaiDN/83GzJ4R7Fa/FimarNBwZ+eW3zRDrv9B4/j/8hKmNJep9cgdB04t89/1O/w1cDnyilFU=');
$bot = new \src\LINEBot($httpClient, ['channelSecret' => '0126e35ca29d722a11fab40b4948db24']);
  ...
  {		
    ...
    {	
			...
			if ($text =='register')
			{
				...
				$textMessageBuilder = new \src\LINEBot\MessageBuilder\TextMessageBuilder('hello');
